(function () {
  ...
  const handleNode = (node) => {
      ...
      return JSON.stringify(Array.prototype.map.call(node, (n) => {
          return getNodeInfo(n);
      }));
  };
  class LoggerMutation extends LoggerBase {
      constructor(TrackType, mutationRecord) {
          super(TrackType);
  ...
  const storeMutation = (mutationRecord) => {
  ...
  window.addEventListener(UIEvent.select, (event) => {
      const loggerUIEvent = new LoggerUIEvent(TrackType.UIEVENT_SELECT, event);
  ...
  class LoggerFocusEvent extends LoggerUIEvent {
      constructor(TrackType, focusEvent) {
  ...
  window.addEventListener(FocusEvent.focusin, (event) => {
      const loggerFocusEvent = new LoggerFocusEvent(TrackType.FOCUSEVENT_FOCUSIN, event);
  ...
  window.addEventListener(FocusEvent.focusout, (event) => {
      const loggerFocusEvent = new LoggerFocusEvent(TrackType.FOCUSEVENT_FOCUSOUT, event);
  ...
  class LoggerPointerEvent extends LoggerMouseEvent {
      constructor(TrackType, pointerEvent) {
