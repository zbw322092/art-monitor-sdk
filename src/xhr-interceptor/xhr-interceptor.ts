...
// const addRequestCallback = (callback: IXHRCallback): void => {
//   requestCallbacks.push(callback);
// };

// const removeRequestCallback = (callback: IXHRCallback): void => {
//   arrayRemove(requestCallbacks, callback);
// };

// const addResponseCallback = (callback: IXHRCallback): void => {
//   responseCallbacks.push(callback);
// };

// const removeResponseCallback = (callback: IXHRCallback): void => {
//   arrayRemove(responseCallbacks, callback);
// };
